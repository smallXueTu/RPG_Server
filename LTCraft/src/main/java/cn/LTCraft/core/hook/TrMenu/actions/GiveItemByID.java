...
/**
 * Created by Angel、 on 2022/5/20 17:06
 */
public class GiveItemByID extends ActionBase {
    public GiveItemByID(@NotNull ActionHandle handle) {
        super(handle);
    }
    ...
    public void onExecute(@NotNull ActionContents contents, @NotNull ProxyPlayer player, @NotNull ProxyPlayer placeholderPlayer) {
        ...
        PlayerUtils.securityAddItem(bukkitPlayer, clutterItem.generate());
